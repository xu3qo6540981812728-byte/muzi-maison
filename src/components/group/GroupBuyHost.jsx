  ...
  if (sessionDoc.missing) {
    ...
    return (
      ...
      <div className="min-h-screen bg-brand-marble flex flex-col items-center justify-center p-6 gap-4">
        ...
        <Link to="/" className="brand-accent-strong font-bold underline">
    ...
    <div className="min-h-screen p-4 md:p-8">
      ...
      <div className="max-w-lg mx-auto bg-white rounded-3xl shadow-xl border border-stone-100 p-6">
        ...
        <div className="flex items-center gap-2 mb-4 border-b border-stone-100 pb-3">
          ...
          <UsersIcon size={24} className="brand-accent shrink-0" />
        ...
        {!currentUser && (
          ...
          <p className="text-sm brand-surface-text font-bold mb-4">
              ...
              {rows.map((r) => (
                ...
                <li key={r.productId} className="px-3 py-2.5 text-sm">
                  ...
                  <div className="text-xs text-stone-600 mt-0.5">
                    ...
                    共 <span className="font-black brand-accent-strong">{r.qty}</span> 件（{r.label}）
        ...
        <Link
          ...
          className="block w-full text-center brand-btn-primary font-black py-3.5 rounded-2xl shadow-md mb-3"
        ...
        <Link
          ...
          className="block text-center text-sm brand-accent-strong font-bold hover:underline mb-2"
        ...
        {!isActive && (
          ...
          <p className="text-center text-xs brand-surface-text font-bold mb-2 px-1 leading-relaxed">{endedMessage}</p>
