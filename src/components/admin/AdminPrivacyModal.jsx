      ...
      <div className="bg-brand-marble rounded-3xl shadow-2xl w-full max-w-4xl max-h-full flex flex-col border border-stone-100 relative">
        ...
        <div className="p-6 border-b border-stone-200 shrink-0 pr-12">
          ...
          <p className="text-sm text-stone-500 mt-1">
            修改後將套用於新註冊客戶；已同意之客戶 PDF 仍保留同意當下之政策快照。
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="block text-sm">
              <span className="font-bold text-stone-600 text-xs">政策版本</span>
              <input
                type="text"
                value={draft.version}
            ...
            <label className="block text-sm">
              <span className="font-bold text-stone-600 text-xs">生效日期</span>
              <input
                type="text"
